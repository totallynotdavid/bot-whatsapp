...
| `src/infrastructure/` | Adapters that implement the ports: whatsapp-web.js, Supabase, Redis, BullMQ, Spotify, Anna's Archive, Imgur, ffmpeg. |
...
`BookCatalog`, `TrackSearch`, `ImageHost`, `ImageEffects`, `MediaConverter`.
